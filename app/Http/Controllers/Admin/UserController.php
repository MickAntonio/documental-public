...
class UserController extends Controller
{
    ...
    public function updateImageProfile(Request $request){
        try{
            $path = 'app/public/uploads/perfis';
            ...
            $format = explode(',', $request->image)[0];
            $base64 = explode(',', $request->image)[1];
            ...
            file_put_contents(storage_path($path. '/' . $imageName), $decodedData);
            ...
            $userInfo = KeycloakClient()->getUser(['id' => Auth::user()->id]);
